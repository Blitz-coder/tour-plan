! function (e) {
    ...
    i.extendOptions(function () {
        for (var e = document.querySelectorAll('script[src*="embed.js"], script[src*="iframely.js"]'), t = 0; t < e.length; t++) {
          ...
          if (i.SCRIPT_RE.test(r)) {
            var n = c(r, i.SUPPORTED_QUERY_STRING.concat("cdn")),
              a = r.match(i.CDN_RE);
      ...
      function (e) {
        for (var t = document.querySelectorAll('iframe[src*="' + (e || i.DOMAINS).join('"], iframe[src*="') + '"]'), r = 0; r < t.length; r++) {
          var a = t[r],
            o = a.src;
          (o.match(/^(https?:)?\/\/[^\/]+\/api\/iframe\?.+/) || o.match(/^(https?:)?\/\/[^\/]+\/\w+(\?.*)?$/)) && n.postMessage({
            method: "getSize"
          }, "*", a.contentWindow)
        }
  ...
  t.addDefaultWrappers = function (e) {
    ...
    if (t) {
      ...
      if ("A" === e.nodeName && e.hasAttribute("href")) r.url = e.getAttribute("href");
      else if (e.hasAttribute("src") && /url=/.test(e.getAttribute("src"))) {
  ...
  function a(e, t) {
    ...
    if (t && t.method) {
      var r = function (e) {
        ...
        src: t.context,
        domains: i.DOMAINS.concat(i.CDN)
      });
      if (r) {
        var o = n.getWidget(r);
  ...
  (function (e) {
    var t = r(0),
      ...
      }("undefined" != typeof window ? window : e, "r webkitR mozR msR oR".split(" "), 0),
      n = {};
  ...
  n.on("load", function (e) {
      ...
      t.length > 1 && function (e) {
        ...
        function l(e) {
          var t = e.getAttribute("data-iframely-url"),
            a = t.match(n.ID_RE),
            d = a && a[1],
            l = i.parseQueryString(t, n.SUPPORTED_QUERY_STRING.concat("url")),
            u = l.url;
          delete l.url;
          ...
          else if (d) e.setAttribute("data-import-uri", d), -1 === o.indexOf(d) && o.push(d), c(d, e);
          else {
    ...
    if (e && e.uri && (e.html || e.cancel)) {
      var r = a[e.uri];
      if (r)
        for (var i = 0; i < r.length; i++) o(e, r[i], t);
      delete a[e.uri]
    }
  ...
  n.on("load", function (e, t) {
    ...
    if (!e && !n.import)
      for (var t = document.querySelectorAll("a[data-iframely-url]:not([data-import-uri])"), r = 0; r < t.length; r++) n.trigger("load", t[r])
  }), n.on("load", function (e) {
    e && "A" === e.nodeName && (e.getAttribute("data-iframely-url") || e.getAttribute("href")) && !e.hasAttribute("data-import-uri") && function (e) {
      ...
      if (t) {
        ...
        if (s)
          for (; s.aspectWrapper.lastChild;) s.aspectWrapper.removeChild(s.aspectWrapper.lastChild);
        else {
    ...
    if (e && "IFRAME" === e.nodeName && e.hasAttribute("data-iframely-url") && e.hasAttribute("data-img") && !e.getAttribute("src")) {
      ...
      ! function (e, t) {
        ...
        var l = n.getElementComputedStyle(e.aspectWrapper, "padding-top"),
          u = n.getElementComputedStyle(e.aspectWrapper, "padding-bottom"),
          p = l.match(/^(\d+)px$/);
        if (p && parseInt(p[1]) && u) {
          var f = document.createElement("div");
          i.setStyles(f, {
      ...
      }(t, r), r = i.addQueryString(r, {
        img: 1
      }), e.setAttribute("data-iframely-url", r), new c(t), n.trigger("load", e)
    }
  }), n.on("message", function (e, t) {
    var r;
  ...
  n.on("load", function (e) {
    if (!e)
      for (var t = document.querySelectorAll("iframe[data-iframely-url]"), r = 0; r < t.length; r++) n.trigger("load", t[r])
  }), n.on("load", function (e) {
    e && "IFRAME" === e.nodeName && e.hasAttribute("data-iframely-url") && !e.hasAttribute("data-img") && !e.getAttribute("src") && function (e) {
      var t = i.getWidget(e),
        r = e.getAttribute("data-iframely-url");
      t && r && (r = i.getEndpoint(r, {
        lazy: n.config.intersection,
        v: n.VERSION,
        app: 1
      }));
  ...
  i.on("message", function (e, t) {
    ...
    if (e) {
      var t = e.maxWidthWrapper && e.maxWidthWrapper.parentNode,
        r = e.maxWidthWrapper;
        ...
        function (e, t) {
          if (t && Object.keys(t).length > 0 && e) {
            var r = function (e) {
              ...
              a = window.getComputedStyle && window.getComputedStyle(e.iframe).getPropertyValue("height"),
              o = t["max-width"];
